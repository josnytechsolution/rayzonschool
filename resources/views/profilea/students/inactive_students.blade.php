    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 mt-4">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">INACTIVE STUDENT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-secondary card-outline no-radius">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fa fa-users"></i> INACTIVE STUDENTS</h3>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped">
                                ...
                                @foreach($students as $student)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">{{ ucwords($student->name) }}</td>
                                        ...
                                        <td style="vertical-align: middle;text-align: center">{{ $student->updated_at }}</td>
