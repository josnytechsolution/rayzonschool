                                        ...
                                        <div class="col-md-12 mb-4">
                                            <div class="btn-group float-right">
                                                    <div class="input-group-prepend ml-2">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            @foreach($class_grades as $class_grade)
                                                                <a class="dropdown-item text-muted" href="{{ route('thisClass', $class_grade->slug) }}">
                                                    ...
                                                    <div class="input-group-prepend ml-2">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item text-danger" href="{{ route('exportAllPDF', "all-students") }}" target="_blank">
                                                                <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                                            </a>
                                                            <a class="dropdown-item text-success" href="{{ route('exportAllExcel', 100) }}">
                                            ...
                                            <table id="example1" class="table table-striped">
                                                ...
                                                @foreach($students as $student)
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset($student->photo) }}" class="img-fluid img-circle pad img-size-32" /></td>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="btn-group float-right">
                                                ...
                                                <div class="input-group-prepend ml-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item text-danger" href="{{ route('exportAllPDF', "all-male-students") }}" target="_blank">
                                                            <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                                        </a>
                                                        <a class="dropdown-item text-success" href="{{ route('exportAllExcel', 101) }}">
                                                            <i class="fa fa-file-excel text-success"></i> Export To Excel
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="btn-group float-right">
                                                ...
                                                <div class="input-group-prepend ml-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item text-danger" href="{{ route('exportAllPDF', "all-female-students") }}" target="_blank">
                                                            <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                                        </a>
                                                        <a class="dropdown-item text-success" href="{{ route('exportAllExcel', 102) }}">
                                                            <i class="fa fa-file-excel text-success"></i> Export To Excel
                                                        </a>
                                                    </div>
                                                </div>
