...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Staff Departments</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card card-success card-outline no-radius">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Create Staff Department</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('staff-departments.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 alert alert-default no-radius border">
                                        <p>Use <code>Teaching</code> for the teaching department</p>
                                        <p>Use <code>Transport</code> for the transport department</p>
                                    </div>
                ...
                <div class="col-md-7">
                    <div class="card card-primary card-outline no-radius">
                        <div class="card-header">
                            <h3 class="card-title">Staff Departments List</h3>
                        </div>
                        <div class="card-body">
                            ...
                            @foreach($departments as $department)
                                ...
                                <div class="modal fade" id="editDepartment{{ $department->id }}" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content no-radius">
                                            <form action="{{ route('staff-departments.update', $department->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade" id="deleteDepartment{{ $department->id }}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">

                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content no-radius">
                                            <form action="{{ route('staff-departments.destroy', $department->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body text-sm">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="alert alert-warning" style="text-align: center">
                                                            ...
                                                            This will delete all information related to this department.<br>
