...
<head>
    ...
    <title>Students Fees Overpayment</title>
...
<p style="text-align: center;">
    ...
    <span style="font-size: 24px">STUDENT FEES OVERPAYMENT</span><br>
</p>
...
<table>
    ...
    <td style="width: 7%;text-align: right"><b>{{ number_format($students->sum('balance'),2) }}</b></td>
    </tbody>
</table>