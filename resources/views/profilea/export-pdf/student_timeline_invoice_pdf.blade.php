...
<h3 style="margin-top: 30px">Invoice To:</h3>
<p>
    <span>{{ strtoupper($student->name) }}</span><br>
    <span>ADMISSION NO: {{ strtoupper($student->admno) }}</span><br>
    <span>CLASS/GRADE: {{ strtoupper($studentTimeline->class_grade->long_name) }}</span><br>
</p>
...
<table style="margin-top: 30px;">
    ...
    <tr>
        ...
        <td style="text-align: right;border-bottom: 1px solid #fff"><b>KES {{ number_format($feePayments->sum('paid'),2) }}</b></td>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align: right"><b>KES {{ number_format($tBalance,2) }}</b></td>
    </tr>
</table>
