...
<head>
    ...
    <title>Students Fee Arrears</title>
...
<p style="text-align: center;">
    ...
    <span style="font-size: 24px">STUDENT LAST TERM FEES BALANCE</span><br>
</p>
...
<table>
    ...
    <td style="width: 7%;text-align: right"><b>{{ number_format($students->sum('arrears'),2) }}</b></td>
    </tfoot>
</table>