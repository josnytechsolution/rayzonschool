...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark"> {{ strtoupper($class_grade->long_name) }} COLLECTED FEES</h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline no-radius">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <i class="fa fa-database"></i>  {{ strtoupper($class_grade->long_name) }}  {{ strtoupper($current_session->name) }} COLLECTED FEES
                                </h3>
                                    ...
                                    <div class="btn-group">
                                        <div class="input-group-prepend ml-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item text-muted" href="{{ route('fee-payment.index') }}">
                                                    All Classes
                                                </a>
                                                @php($class_grads = App\ClassGrade::Active()->orderBy('id', 'asc')->get())
                                                @foreach($class_grads as $class_grad)
                                                    <a class="dropdown-item text-muted" href="{{ route('paymentByClass', $class_grad->slug) }}">
                                        ...
                                        <div class="input-group-prepend ml-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item text-danger" href="{{ route('exportFeePDF', $class_grade->slug) }}" target="_blank">
                                                    <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                                </a>
                                                <a class="dropdown-item text-success" href="{{ route('exportFeeExcel', $class_grade->id) }}">
                                            ...
                                            @php($i = 1)
                                               @foreach($payments as $payment)
                                                   <tr>
                                                       ...
                                                       <!-- Start Delete Modal -->
                                                       <div class="modal fade" id="deletePayment{{ $payment->id }}" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
