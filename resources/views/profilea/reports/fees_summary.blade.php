                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline no-radius">
                            <div class="card-header">
                                <h3 class="card-title">
                                   <i class="fa fa-database"></i> {{ strtoupper($current_session->name) }} FEES SUMMARY
                                </h3>
                                ...
                                <div class="card-tools">
                                    <div class="btn-group">
                                        ...
                                        <div class="input-group-prepend ml-2">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @foreach($class_grades as $class_grade)
                                                    <a class="dropdown-item text-muted" href="{{ route('thisSummaryClass', $class_grade->slug) }}">
                                        ...
                                        <div class="input-group-prepend ml-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item text-danger" href="{{ route('exportFeeSummaryPDF', "all-classes") }}" target="_blank">
                                                    <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                                </a>
                                                <a class="dropdown-item text-success" href="{{ route('exportFeeSummaryExcel', 100) }}">
