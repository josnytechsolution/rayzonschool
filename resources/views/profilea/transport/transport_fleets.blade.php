...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Transport Fleets</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Add Transport Vehicle</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('transport-fleets.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="text" name="reg_no" class="form-control @error('reg_no') is-invalid @enderror no-radius" value="{{ old('reg_no') }}">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror no-radius" value="{{ old('capacity') }}">
