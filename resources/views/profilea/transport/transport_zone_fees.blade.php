...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Transport Zone Fees</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Add Transport Zone Fee</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('transport-zone-fees.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="one_way" class="form-control @error('one_way') is-invalid @enderror no-radius" value="{{ old('one_way') }}">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="two_way" class="form-control @error('two_way') is-invalid @enderror no-radius" value="{{ old('two_way') }}">
                                    ...
                                    <div class="form-group col-md-12 mt-4">
                                        <button type="submit" class="btn btn-primary float-right no-radius" >
                                            <i class="fa fa-save"></i> Save Zone Fee
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-body">
                            ...
                            @foreach($zone_fees as $zone_fee)
                                <tr>
                                    ...
                                    <td>{{ $zone_fee->transport_zone->areas }}</td>
