...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Transport Zone</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-success">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Edit Transport Zone</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('transport-zones.update', $transportZone->slug) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Zone Name</label>
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('name', $transportZone->name) }}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="text" name="long_name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('long_name', $transportZone->long_name) }}">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <textarea name="areas" class="form-control @error('name') is-invalid @enderror no-radius" rows="3">{{ old('long_name', $transportZone->areas) }}</textarea>
                                        @if($errors->has('areas'))
                                            <small class="text-danger">{{ $errors->first('areas') }}</small>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-12 mt-4">
                                        <a href="{{ route('transport-zones.index') }}" class="btn btn-secondary btn-flat">
