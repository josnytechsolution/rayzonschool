            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">
                        SEND FEES REMINDER <small>TO SELECTED STUDENTS</small>
                    </h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <select id="student_id" name="student_id" class="form-control select2" required>
                                                ...
                                                @foreach($students as $student)
                                                    <option value="{{ $student->id }}">{{ $student->admno." - ".$student->name." - ".$student->class_grade->name." - ".$student->parent_detail->primary_contact." - KES. ".$student->balance }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-2">
                                            <label class="text-white">..</label><br>
                                        <button class="btn btn-primary btn-flat float-right" id="add-student"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                            </div>
                                <div class="col-md-12 mb-4">
                                    <table class="table table-striped">
                                        ...
                                        @foreach($temps as $temp)
                                            <tr>
                                                ...
                                                <td>{{ $temp->student->balance }}</td>
                                                <td>
                                                    <button type="button" class="btn btn-outline-danger btn-xs" onClick="deleteTemp({{ $temp->id }})"><i class='fa fa-trash'></i> </button>
                                                </td>
                                            </tr>
                                            @php($i++)
                                        @endforeach
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline no-radius">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ route('sendToSelectedStudentWithFigures') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
