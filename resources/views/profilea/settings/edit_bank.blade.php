...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">BANK ACCOUNT <small><i class="fa fa-angle-right"></i> {{ strtoupper($bank->long_name) }}</small> </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline no-radius">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-university"></i> Edit Bank Account</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('bank-accounts.update', $bank->slug) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Bank Name (Short Name)</label>
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('name', $bank->name) }}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12 mb-1">
                                        ...
                                        <input type="text" name="long_name" class="form-control @error('long_name') is-invalid @enderror no-radius" value="{{ old('long_name', $bank->long_name) }}">
                                    ...
                                    <div class="form-group col-md-12 mb-1">
                                        ...
                                        <input type="text" name="branch" class="form-control @error('branch') is-invalid @enderror no-radius" value="{{ old('branch', $bank->branch) }}">
                                    ...
                                    <div class="form-group col-md-12 mb-1">
                                        ...
                                        <input type="text" name="account_name" class="form-control @error('account_name') is-invalid @enderror no-radius" value="{{ old('account_name', $bank->account_name) }}">
                                    ...
                                    <div class="form-group col-md-12 mb-1">
                                        ...
                                        <input type="text" name="account_no" class="form-control @error('account_no') is-invalid @enderror no-radius" value="{{ old('account_no', $bank->account_no) }}">
                                    ...
                                    <div class="form-group col-md-12 mb-1">
                                        <label>Status</label>
                                        <select name="status" class="form-control @error('status') is-invalid @enderror no-radius">
                                            <option value="{{ $bank->getOriginal('status') }}">{{ $bank->status }}</option>
                                    ...
                                    <div class="form-group col-md-12 mt-3">
                                        <a href="{{ route('bank-accounts.index') }}" class="btn btn-secondary btn-flat" >
                                            ...
                                            <form action="{{ route('bank-accounts.destroy', $bank->slug) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalCenterTitle">
                                                        <i class="fa fa-trash text-danger"></i> Delete Bank Account: {{ strtoupper($bank->long_name) }}
                                                    </h5>
