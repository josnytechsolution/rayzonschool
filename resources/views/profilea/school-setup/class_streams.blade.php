...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Class Stream</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Create Grade Stream</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('class-streams.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mt-4">
                                        <button type="submit" class="btn btn-primary float-right no-radius" >
                                            <i class="fa fa-save"></i> Save Class Stream
                                        </button>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-md-8">
                    <div class="card no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title">Class/Grade Streams List</h3>
                        </div>
                        <div class="card-body">
