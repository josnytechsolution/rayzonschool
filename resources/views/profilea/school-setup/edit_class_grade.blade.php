...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit {{ strtoupper($classGrade->long_name) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-success">
                        ...
                        <div class="card-body">
                            <form action="{{ route('class-grades.update', $classGrade->slug) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Class Name</label>
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('name', $classGrade->name) }}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="text" name="long_name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('long_name', $classGrade->long_name) }}">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="number" name="level" class="form-control @error('level') is-invalid @enderror no-radius" value="{{ old('level', $classGrade->level) }}">
                                        @if($errors->has('level'))
                                            <small class="text-danger">{{ $errors->first('level') }}</small>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-12 mt-4">
                                        <a href="{{ route('class-grades.index') }}" class="btn btn-warning no-radius" >
