    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 mt-4">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">FEES DISCOUNTS</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="card-tools">
                                <div class="btn-group">
                                    <div class="input-group-prepend ml-2">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @foreach($class_grades as $class_grade)
                                                <a class="dropdown-item text-muted" href="{{ route('classFeeDiscount', $class_grade->slug) }}">
                                    ...
                                    <div class="input-group-prepend ml-2">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item text-danger" href="{{ route('feeDiscountPDF', "all-classes") }}" target="_blank">
                                                <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                            </a>
                                            <a class="dropdown-item text-success" href="{{ route('feeDiscountExcel', 100) }}">
