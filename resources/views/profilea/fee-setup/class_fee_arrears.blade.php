    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2 mt-4">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ strtoupper($class_grade->name) }} ARREARS BROUGHT FORWARD</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fa fa-database"></i> {{ strtoupper($class_grade->name) }} STUDENTS WITH FEE BALANCES BROUGHT FORWARD
                            </h3>
                                ...
                                <div class="btn-group">
                                    <div class="input-group-prepend ml-2">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item text-muted" href="{{ route('arrears') }}">
                                                All Classes
                                            </a>
                                            @php($class_grads = App\ClassGrade::Active()->orderBy('name', 'asc')->get())
                                            @foreach($class_grads as $class_grad)
                                                <a class="dropdown-item text-muted" href="{{ route('arrearsByClass', $class_grad->slug) }}">
                                    ...
                                    <div class="input-group-prepend ml-2">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item text-danger" href="{{ route('exportArrPDF', $class_grade->slug) }}" target="_blank">
                                                <i class="fa fa-file-pdf text-danger"></i> Export To PDF
                                            </a>
                                            <a class="dropdown-item text-success" href="{{ route('exportArrExcel', $class_grade->id) }}">
                            ...
                            <table id="example1" class="table table-striped">
                                ...
                                @foreach($arrears as $arrear)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">{{ strtoupper($arrear->class_grade->long_name) }}</td>
