...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit {{ $feeParameter->name }} Parameter</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-success">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-edit"></i> Edit {{ $feeParameter->name }} Parameter</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('fee-parameters.update', $feeParameter->slug) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Parameter Name</label>
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror no-radius" value="{{ old('name', $feeParameter->name) }}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input type="text" name="description" class="form-control @error('description') is-invalid @enderror no-radius" value="{{ old('description', $feeParameter->description) }}">
                    ...
                    <div class="card no-radius bg-white">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($parameters as $parameter)
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade" id="deleteParameter{{ $parameter->slug }}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
