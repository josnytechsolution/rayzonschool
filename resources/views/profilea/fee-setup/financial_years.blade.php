...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Financial Year</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-4">
                    <div class="card no-radius bg-white">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Create Financial Year</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mt-4">
                                        <button type="submit" class="btn btn-primary float-right no-radius" >
                                            <i class="fa fa-save"></i> Save Year
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="card no-radius bg-white">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($fyears as $fyear)
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade" id="deleteFYear{{ $fyear->slug }}" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
