                ...
                <div class="col-md-12">
                    <div class="card card-success card-outline no-radius">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> Add An Expense</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('expenses.store') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mt-3">
                                        ...
                                        <input type="date" name="expense_date" class="form-control @error('expense_date') is-invalid @enderror no-radius" value="{{ old('expense_date') }}">
                                    ...
                                    <div class="form-group col-md-4 mt-3">
                                        ...
                                        <input type="text" name="amount" class="form-control @error('amount') is-invalid @enderror no-radius" value="{{ old('amount') }}">
                                    ...
                                    <div class="form-group col-md-4 mt-3">
                                        ...
                                        <input type="text" name="ref_no" class="form-control @error('ref_no') is-invalid @enderror no-radius" value="{{ old('ref_no') }}">
